...
3. 按时长档控制页数——**按正文页（content）计,分隔页不算数**：
   10 分钟 5–8 张正文页、15 分钟 8–12 张、20 分钟 12–16 张。
   **上限同样是硬要求**：15 分钟讲 14 页正文＝每页 40 秒,评委还没看清就翻过去了
   （实测出过 22 页的 15 分钟稿）。宁可少讲几页讲透,不要铺满。
...
没有任何内容的 PPT，还照常扣了积分）。**通篇一个版式会被判无效并要求重做**：6 页正文起至少 1 页、
12 页起至少 2 页必须是 chart 或 comparison。凡是评委会关心的团队/业绩/报价/工期类数字，
一律用 chart 或 comparison 提炼出来，不能一路 bullets 到底（实测出过 14 页正文里 13 页纯要点，
内容量够了但评委翻到后面全是项目符号列表）。

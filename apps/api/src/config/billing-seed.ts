...
// 各操作积分口径 credit_cost.<key>：7 项以 C 端「积分消耗说明」为准（见 credit-cost-items.ts），运营后台可改。
...
export const BILLING_SEED: Record<string, unknown> = {
  ...
  grant_expire_days: 0, // 赠送积分有效期（0=不过期，产品口径：注册送积分不过期）
  reward_expire_days: 0, // 奖励积分有效期（0=不过期，产品口径：邀请积分不过期）
